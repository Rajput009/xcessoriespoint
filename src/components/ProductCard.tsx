      ...
      <div className={listView ? "min-w-0 flex-1 pt-0.5" : "pt-3"}>
        ...
        {!compact && (
          <button
            ...
            onClick={openOptionsOrAdd}
            className={`mt-3 flex w-full items-center justify-center rounded-md py-2.5 text-xs font-bold transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              soldOut
